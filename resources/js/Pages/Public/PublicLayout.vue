    ...
    <div id="page" class="s-pagewrap ss-home">
        ...
        <header id="masthead" class="s-header">
            ...
            <div class="s-header__branding">
                <p class="site-title">
                    <a href="index.html" rel="home">Pamir Culture.</a>
                </p>
            </div>
                    ...
                    <ul class="s-header__nav">
                        ...
                        <li class="has-children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="#">Food</a></li>
                                <li><a href="#">Traditions & Holidays</a></li>
                ...
                <div class="hero__slider swiper-container">
                    ...
                    <div class="swiper-wrapper">
                        <article class="hero__slide swiper-slide">
                            <div class="hero__entry-image" style="background-image: url('images/thumbs/featured/3.jpg');"></div>
            ...
            <div class="row s-footer__bottom">
                ...
                <div class="column lg-5 md-6 tab-12">
                    <div class="ss-copyright">
                        <span>© Copyright Pamir Culture. 2022</span>
                        <span>Design by <a href="#">Coded</a></span>
                    </div>
                </div>
